...
export const metadata: Metadata = {
  title: "Altitude Capital | San Francisco Private Equity Fund",
  description: "Institutional private equity fund investing in mid-market companies. Deep operational expertise and proven track record of value creation for investors and portfolio companies.",
  keywords: "private equity, San Francisco, venture capital, institutional investment, mid-market",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Altitude Capital | San Francisco Private Equity",
    description: "Institutional capital and operational expertise for transformative growth",
    type: "website",
    siteName: "Altitude Capital"
  }
};
